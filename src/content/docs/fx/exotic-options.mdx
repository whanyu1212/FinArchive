...
<Chart id="digital-call" config={{
  type: 'line',
  data: {
    labels: ['1.06', '1.07', '1.08', '1.09', '1.10', '1.11', '1.12', '1.13', '1.14'],
    datasets: [{
      label: 'Digital Call Payout ($1M)',
  ...
  options: {
    ...
    scales: {
      y: { 
        title: { display: true, text: 'Payout (Millions)' }, 
        beginAtZero: true,
        max: 1.2
      },
      x: { title: { display: true, text: 'EUR/USD Spot at Expiry' } }
    },
    plugins: {
