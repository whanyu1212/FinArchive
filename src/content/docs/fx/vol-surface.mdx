...
<div style="margin: 2rem 0;">
  <Chart id="smile-vs-skew" config={{
    type: 'line',
    data: {
      labels: ['10D Put', '25D Put', 'ATM', '25D Call', '10D Call'],
      datasets: [
        {
          label: 'Symmetric Smile (FX Majors)',
          data: [12.5, 10.5, 8.5, 10.5, 12.5],
        ...
        {
          label: 'Skewed Smile / Put Skew (USD/EM)',
          data: [15.0, 12.0, 9.0, 8.2, 8.5],
...
- **PUT SKEW (Negative): Vol(25D put) > Vol(25D call)**
  ...
  - Also seen in EUR/USD (flight-to-quality USD bids).

- **CALL SKEW (Positive): Vol(25D call) > Vol(25D put)**
  - Market fears upside more than downside.
  - Classic in USD/JPY when the BoJ is intervening.
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1rem; margin-bottom: 2rem;">
  <div>
    ...
    <Chart id="vol-contango" config={{
      type: 'line',
      data: {
        labels: ['1W', '1M', '3M', '6M', '1Y', '2Y'],
        datasets: [{
          label: 'Implied Volatility',
          data: [6.0, 7.0, 7.5, 8.0, 8.5, 9.0],
          borderColor: 'rgba(54, 162, 235, 1)',
          backgroundColor: 'rgba(54, 162, 235, 0.1)',
          fill: true,
          tension: 0.4,
      ...
      options: {
        responsive: true,
        scales: {
          y: { title: { display: true, text: 'Implied Vol (%)' } },
    ...
    <p style="font-size: 0.85em; margin-top: 0.5rem;">
      → <strong>Near-term vol < long-term vol</strong><br/>
      → Normal state: uncertainty accumulates over time<br/>
  ...
  <div>
    ...
    <Chart id="vol-backwardation" config={{
      type: 'line',
      data: {
        labels: ['1W', '1M', '3M', '6M', '1Y', '2Y'],
        datasets: [{
          label: 'Implied Volatility',
          data: [12.0, 10.0, 8.5, 8.0, 7.8, 7.5],
          borderColor: 'rgba(255, 99, 132, 1)',
          backgroundColor: 'rgba(255, 99, 132, 0.1)',
          fill: true,
          tension: 0.4,
    ...
    <p style="font-size: 0.85em; margin-top: 0.5rem;">
      → <strong>Near-term vol > long-term vol</strong><br/>
      → CLASSIC SIGNAL: high-impact event risk in the near term<br/>
